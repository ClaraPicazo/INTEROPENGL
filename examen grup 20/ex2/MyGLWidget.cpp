...
{
	//terra de 20x20 situat al origen (0,0,0) i 3 patricios apilats d'altures 3+2.5+2
	// mins = (x = -10, y = 0, z = -10)  maxs = (x = 10, y = 7.5, z = 10)
	radi = glm::distance(glm::vec3(-10,0,-10),glm::vec3(10,7.5,10))/2; //radi caixa contenidora
	distance = 2*radi;
	//Terra centrat al origen => 
	VRP = glm::vec3(0,0,0);
	...
	ZNear = distance - radi;
	ZFar = distance + radi;
	FOVinicial = 2 * asin(radi/distance);
...
void MyGLWidget::paintGL ()
{
  ...
  // Activem el VAO per a pintar el Patricio1
...
void MyGLWidget::calculaCapsaModel ()
{
  ...
  //radi = glm::distance(glm::vec3(maxx, ((float)7.5/(float)3)*maxy, maxz), glm::vec3(minx, miny, minz))/2;

  //Alçada 3 
  escalaPatricio1 = 3.0/(maxy-miny);
  //Alçada 2.5
  escalaPatricio2 = 2.5/(maxy-miny);
  //Alçada 2
  escalaPatricio3 = 2.0/(maxy-miny);
}
...
void MyGLWidget::modelTransformPatricio2 ()
{
  ...
  //glm::rotate(Model, angle_in_degrees, glm::vec3(x, y, z))  π degrees son 180º
...
void MyGLWidget::projectTransform ()
{
  ...
  //glm::perspective(fovy, aspect(w/h), ZNear, ZFar);
