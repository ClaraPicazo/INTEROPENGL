...
double dist3Origen(glm::vec3 orig, glm::vec3 dest)
{
...
{
    //calcul centre caixa
    glm::vec3 CBP ((patrMin.x+patrMax.x)/2,(patrMin.y+patrMax.y)/2,(patrMin.z+patrMax.z)/2);
    //calcul distancia
    double d = dist3Origen(CBP,patrMax);
    //calcul matriu VM
    glm::mat4 view = glm::translate(glm::mat4(1.0f),glm::vec3(0.,0.,-d+1.5));
    view = glm::translate(view,-CBP);
